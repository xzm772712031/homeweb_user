					...
					<div class="am-g">
						...
						<div class="am-u-md-9">
							<div class="topbar-right am-text-right am-fr">
								...
								<i class="am-icon-rss"></i> <a href="./login.html">登录</a> <a
				...
				<div class="nav-contain">
					<div class="nav-inner">
						<ul class="am-nav am-nav-pills am-nav-justify">
							...
							<li><a href="./news.html">新闻中心</a> <!-- sub-menu start-->
								<ul class="sub-menu">
		...
		<div class="layout-container">
			<div class="page-header">
				<div class="am-container">
					<h1 class="page-header-title">预约服务</h1>
				</div>
			</div>
			...
			<div class="breadcrumb-box">
				<div class="am-container">
					<ol class="am-breadcrumb">
						...
						<li class="am-active">预约服务</li>
					</ol>
				</div>
			</div>
		</div>
         <form action="insertBespeak" method="post">
		<div align="center">
			<div class="am-form-group">
				<label for="doc-select-1">服务类型：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
				<select id="doc-select-1" name="Bespeak_Type">
			...
			<div class="am-form-group">
				...
				<select id="doc-select-2" name="Type_Thing">
					<c:forEach items="${thingList }" var="t">
					<option value=${t.thing_id }>${t.thing_Name }</option>
					</c:forEach>
				</select> <span class="am-form-caret"></span>
			</div>
			...
			<div class="am-form-group">
			 ...
			 <label for="doc-ipt-email-1">用户编号：</label> <input name="User_Id" type="text"
					value="${user_Id }"  required />
			</div>
			
			<div class="am-form-group">
				<label for="doc-ipt-email-1">姓名：</label> <input name="Customer" type="text" class=""
					id="doc-ipt-email-1" placeholder="输入姓名" size="14"> <label
					for="doc-ipt-email-1">日期：</label> <input name="Bespeak_Date" type="text"
					placeholder="日历组件" data-am-datepicker required />
			</div>
			<div class="am-form-group">
			<label for="doc-ipt-email-1">国家：</label> 
			<input name="Address_Country" type="text" class=""
			id="doc-ipt-email-1" placeholder="国家" size="14">
			</div>
			<div class="am-form-group">
			<label for="doc-ipt-email-1">城市：</label> 
			<input name="Address_City" type="text" class=""
			id="doc-ipt-email-1" placeholder="城市" size="14">
			</div>
			<div class="am-form-group">
			<label for="doc-ipt-email-1">搬入地：</label> 
			<input name="Address_In" type="text" class=""
			id="doc-ipt-email-1" placeholder="搬出地" size="14">
			<label for="doc-ipt-email-1">搬出地：</label> 
			<input name="Address_Out" type="text" class=""
			id="doc-ipt-email-1" placeholder="搬入地" size="14">
			</div>
			<div class="am-form-group">
			<label for="doc-ipt-email-1">电话：</label> 
			<input name="Tel" type="text" class=""
			id="doc-ipt-email-1" placeholder="输入电话" size="14">
			</div>
			<div class="am-form-group">
			<label for="doc-ipt-email-1">说明：</label> 
			<textarea rows="5" cols="40" name="Add_Context">
			</textarea>
			</div>
			...
			<div class="container">
				<div class="section--header">
					...
					<p class="section--description">
						云适配致力于为企业提供全球最先进的移动化技术帮助企业最高效安全实现生产力提升<br /> One Web，Any Device
					</p>
				</div>
