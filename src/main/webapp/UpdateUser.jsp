    ...
    $("#btn").click(function(){
      　var reg = new RegExp("^[a-z0-9]+([._\\-]*[a-z0-9])*@([a-z0-9]+[-a-z0-9]*[a-z0-9]+.){1,63}[a-z0-9]+$");
       ...
       return false;    
        ...
        alert("手机号码格式不正确！"); 
         return false; 
        }else if(UserAddress.length==0||UserBirthday.length==0||USerSex.length==0){       
         alert("关键系你先不能为空！");     
          return false; 
        }
  ...
  <body class="register-container">
   <div class="layout">
    ...
    <div class="register-box">
      <form action="updateUser" class="am-form" data-am-validator method="post">
        <fieldset>
          <legend>个人信息<p class="register-info">信息修改与查看</p></legend>
          <div class="am-form-group">
            <div class="am-g">
              ...
              <div class="am-u-md-10">
                <input type="text"  minlength="2" id="UserName" name="UserName" value="${user.userName}"
          ...
          <div class="am-form-group">
            <div class="am-g">
              ...
              <div class="am-u-md-10">
                <input type="text"  placeholder="请输入您的邮箱" id="UserEmail" name="UserEmail" minlength="3" required value="${user.userEmail}" />
              </div>
            </div>
          </div>
          ...
          <div class="am-form-group">
            <div class="am-g">
              ...
              <div class="am-u-md-10">
                <input type="text" placeholder="请输入您的电话"  required minlength="3" id="UserTel" name="UserTel" value="${user.userTel}" />
              </div>
            </div>
          </div>
          ...
          <div class="am-form-group">
            <div class="am-g">
              ...
              <div class="am-u-md-10">
                ...
                <c:if test="null!=${user.USerSex}"></c:if>
        ...
        <option value="女">女</option>
          ...
          <div class="am-form-group">
            <div class="am-g">
              ...
              <div class="am-u-md-10">
                <input type="text"  placeholder="请输入您的地址" required minlength="3" name="UserAddress" id="UserAddress" value="${user.userAddress}" />
              </div>
            </div>
          </div>
           ...
           <div class="am-form-group">
            <div class="am-g">
              ...
              <div class="am-u-md-10">
                <input type="text"  placeholder="请输入您的身份证"  required minlength="3" name="UserPersonId" id="UserPersonId" value="${user.userPersonId}" />
              </div>
            </div>
          </div>
          <div class="am-form-group">
            <div class="am-g">
              ...
              <input type="text" class="am-form-field" placeholder="日历组件" readonly name="UserBirthday" value="${user.strDate}" id="UserBirthday">
          ...
          <div class="am-g">
            <div class="am-u-md-10">
                <input type="button" class="am-btn am-btn-secondary" type="submit" value="保存修改" id="btn">
            </div>
          </div>
        </fieldset>
      </form>
