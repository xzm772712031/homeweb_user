...
<html>
  ...
  $(function(){
    $("#btn").click(function(){
        ...
        var passwordold = $("#doc-vld-pwd-3").val();
        alert(passwordold);
            $.ajax({
                type:'post',
                url:'updatePassword',
          ...
          <div class="am-form-group">
            <div class="am-g">
              <div class="am-u-md-2 am-padding-0 am-text-right">
                <label for="doc-vld-pwd-1" class="register-pwd" >原密码</label>
              </div>
              <div class="am-u-md-10">
                <input type="password" id="doc-vld-pwd-3" name="userPassword" placeholder="输入密码（至少 8位）" minlength="8" required/>
              </div>
            </div>
          </div>
           <div class="am-form-group">
