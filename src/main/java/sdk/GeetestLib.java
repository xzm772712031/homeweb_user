...
public class GeetestLib {
	 ...
	 * 公钥
	 */
	private String captchaId = "f0b8b5388f7f81db3ea092b19717fb6d";

	/**
	 * 私钥
	 */
	private String privateKey = "7573ce4d3c3ddc9941e4e2ff8f3162aa";
	 ...
	 * @return 1表示初始化成功，0表示初始化失败
	 */
	public int preProcess(String user_Id){
	 ...
	 * @return 验证结果,1表示验证成功0表示验证失败
	 */
	public int enhencedValidateRequest(String challenge, String validate, String seccode, String user_Id) {	
